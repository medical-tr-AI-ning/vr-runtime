...
namespace Valve.VR
{
    ...
    public class SteamVR_Input_ActionSet_default : Valve.VR.SteamVR_ActionSet
    {
        ...
        public virtual SteamVR_Action_Boolean ActivateSpeech
        {
            get
            {
                return SteamVR_Actions.default_ActivateSpeech;
            }
        }
        
        public virtual SteamVR_Action_Boolean DeactiveSpeech
        {
            get
            {
                return SteamVR_Actions.default_DeactiveSpeech;
            }
        }
        
        public virtual SteamVR_Action_Boolean OpenDialogueUI
        {
            get
            {
                return SteamVR_Actions.default_OpenDialogueUI;
            }
        }
        
        public virtual SteamVR_Action_Boolean Highlight
        {
            get
            {
                return SteamVR_Actions.default_Highlight;
            }
        }
        ...
        public virtual SteamVR_Action_Vector2 navigateUI
        {
            get
            {
                return SteamVR_Actions.default_navigateUI;
            }
        }
