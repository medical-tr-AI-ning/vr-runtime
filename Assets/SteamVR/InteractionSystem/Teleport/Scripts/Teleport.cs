...
namespace Valve.VR.InteractionSystem
{
	...
	public class Teleport : MonoBehaviour
    {
		...
		public LineRenderer floorDebugLine;
				...
				protected LineRenderer pointerLineRenderer;
		protected GameObject teleportPointerObject;
		protected Transform pointerStartTransform;
		protected Hand pointerHand = null;
		protected Player player = null;
		protected TeleportArc teleportArc = null;
		...
		protected Vector3 pointedAtPosition;
		protected Vector3 prevPointedAtPosition;
		protected bool teleporting = false;
		protected float currentFadeTime = 0.0f;

		protected float meshAlphaPercent = 1.0f;
		protected float pointerShowStartTime = 0.0f;
		protected float pointerHideStartTime = 0.0f;
		protected bool meshFading = false;
		protected float fullTintAlpha;

		protected float invalidReticleMinScale = 0.2f;
		protected float invalidReticleMaxScale = 1.0f;
		protected float invalidReticleMinScaleDistance = 0.4f;
		protected float invalidReticleMaxScaleDistance = 2.0f;
		protected Vector3 invalidReticleScale = Vector3.one;
		protected Quaternion invalidReticleTargetRotation = Quaternion.identity;

		protected Transform playAreaPreviewTransform;
		protected Transform[] playAreaPreviewCorners;
		protected Transform[] playAreaPreviewSides;

		protected float loopingAudioMaxVolume = 0.0f;

		protected Coroutine hintCoroutine = null;

		protected bool originalHoverLockState = false;
		protected Interactable originalHoveringInteractable = null;
		protected AllowTeleportWhileAttachedToHand allowTeleportWhileAttached = null;

		protected Vector3 startingFeetOffset = Vector3.zero;
		protected bool movedFeetFarEnough = false;
